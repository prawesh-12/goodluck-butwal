...
import { settings, uiStrings } from "@goodluck/db/schema";
...
const homeRows: StringRow[] = [
  ...
  { key: "home.team.badge", value: "Expert team members", group: "home", label: "Team badge", help: "The small pill above the team cards on the home page." },
  { key: "home.team.title", value: "Our team at your service", group: "home", label: "Team heading", help: "Heading above the team cards on the home page. The cards open on the visitor's office." },
  { key: "home.team.cta", value: "Whole team", group: "home", label: "Team button", help: "Button beside the team heading on the home page. Opens the team page." },

import { z } from "zod";
import { INTAKE_MONTHS, coursePath, qualificationLevels } from "@/components/admin/course-meta";
import { contentStatuses, missingAltProblems, seoFields, slugField, type AttachedImage } from "./page";

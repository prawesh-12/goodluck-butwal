    ...
    <>
          ...
          <div className="flex flex-col items-center gap-[30px] md:gap-10 lg:gap-[50px]">
            ...
            {office.credentialsHtml && (
              <div className="flex w-full max-w-[800px] flex-col gap-[30px]">
                <SectionHead align="left" title="Credentials" />
      ...
      {services.length > 0 && (
        <section className="pb-section flex w-full flex-col items-center">
          <div className="container-x">
            <div className="flex flex-col items-center gap-[30px] md:gap-10 lg:gap-[50px]">
              <SectionHead badge="What we do here" title="Services from this office" />
      ...
      {staff.length > 0 && (
        <section className="pb-section flex w-full flex-col items-center">
          <div className="container-x">
            <div className="flex flex-col items-center gap-[30px] md:gap-10 lg:gap-[50px]">
              <SectionHead badge="The team here" title={`Our people in ${office.city}`} />
      ...
      <section className="pb-section flex w-full flex-col items-center">
        <div className="container-x">
          <div className="flex flex-col items-center gap-[30px]">
            <SectionHead badge="Talk to us" title={`Book a consultation in ${office.city}`} />
